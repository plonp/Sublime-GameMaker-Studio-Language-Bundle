...
3. Extract and copy folder to Sublime Packages path (In Sublime : Preferences > Browse Packages...)
or
1. Clone repo to your Sublime Package path (In Sublime : Preferences > Browse Packages...)
